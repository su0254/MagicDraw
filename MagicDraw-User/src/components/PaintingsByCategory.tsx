...
const PaintingsByCategory = () => {
  ...
  const {categoryName} = useParams<{categoryName: string}>(); // Get categoryId from URL parameters
  ...
  useEffect(() => {
    ...
    dispatch(fetchPaintingsByCategory(categoryName!)); // Fetch paintings by category
